...
Comparator.SaveAccess = (function() {
    ...
    function onInternationalizedMessages() {
        if(this.userLang == 'pt-BR') {
            ...
            this.of = 'de';
            this.users = 'features';
            this.searchSelectionUsers = 'Pesquisar features disponíveis';
            this.searchSelectedUsers = 'Pesquisar features selecionadas';
        }
        if(this.userLang == 'en-US') {
            this.available = 'Available';
            this.of = 'of';
            this.users = 'features';
            this.searchSelectionUsers = 'Search for available features';
            this.searchSelectedUsers = 'Search for selected features';
        }
    };
